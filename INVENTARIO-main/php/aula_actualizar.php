<?php
    ...
    */
    ...
    if($nombre!=$datos['aula_nombre']){
        ...
        $check_nombre=$check_nombre->query("SELECT aula_nombre FROM aulas WHERE aula_nombre='$nombre'");
    ...
    $actualizar_aula=$actualizar_aula->prepare("UPDATE aulas SET aula_nombre=:nombre,aula_ubicacion=:ubicacion, aula_descripcion=:descripcion WHERE aula_id=:id");
