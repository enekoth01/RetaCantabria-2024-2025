<?php
    ...
    // Verificando email de cara a actualizarlo, en caso de que el email no este vacio y tampoco sea el del usuario, por lo que no se ejecutará sino se cambia la dirección de email.
    ...
    // Verificando usuario. Lo mismo, se validará en caso de que el usuario no haya cambiado su nombre de usuario.
