<?php
	/**
	 * Nombre del fichero: user_update.php
	 * Descripción: Actualiza los datos de un usuario en el sistema.
	 * 
	 * Autor: RetaCantabria - ASIR1 - Dpto. Informática - IES Alisal
	 * Fecha: Marzo 2025
	 * 
	 * Parámetros de entrada: 
	 *   - user_id_up (ID del usuario a actualizar)
	 *
	 * Salida: Ninguno
	 */


	// Requerimos el archivo main.php para poder acceder a la función conexion().
...
<div class="container pb-6 pt-6">
	...
	<form action="./php/usuario_actualizar.php" method="POST" class="FormularioAjax" autocomplete="off" onsubmit="return validar_clave()">
